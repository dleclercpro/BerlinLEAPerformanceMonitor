...
import BrokenUIError from '../errors/BrokenUIError';
...
class GetSkilledWorkerWithDegreeAppointmentScenario extends Scenario {
    private static instance: GetSkilledWorkerWithDegreeAppointmentScenario;
    ...
    public static getInstance() {
        if (!GetSkilledWorkerWithDegreeAppointmentScenario.instance) {
            GetSkilledWorkerWithDegreeAppointmentScenario.instance = new GetSkilledWorkerWithDegreeAppointmentScenario();
        }

        return GetSkilledWorkerWithDegreeAppointmentScenario.instance;
    }
    ...
    protected async doExecute(bot: Bot) {
        ...
        await appointmentPage.clickOnSkilledWorkerWithDegreeButton();
...
export default GetSkilledWorkerWithDegreeAppointmentScenario.getInstance();